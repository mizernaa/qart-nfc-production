        ...
        if (data.success) {
          ...
          setProfileData(prevData => ({
            ...
            banking: data.profile.bankAccounts && data.profile.bankAccounts.length > 0 
              ...
              : prevData.banking,
            // Hizmetler - API'den gelen verileri direkt kullan
            services: data.profile.services ? data.profile.services.map((service: any) => ({
            ...
            // Deneyimler - API'den gelen verileri direkt kullan
            experience: data.profile.experiences ? data.profile.experiences.map((exp: any) => ({
              title: exp.title || "",
              company: exp.company || "",
              period: exp.period || "",
            ...
            // Eğitim - API'den gelen verileri direkt kullan
            ...
            // Özellikler - API'den gelen verileri direkt kullan
            features: data.profile.features ? data.profile.features.map((feature: any) => ({
              name: feature.name || "",
